...
_VERIFYCHANBACKUPRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='singles_valid', full_name='lnrpc.VerifyChanBackupResponse.singles_valid', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='singles_valid', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='multi_valid', full_name='lnrpc.VerifyChanBackupResponse.multi_valid', index=1,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='multi_valid', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
